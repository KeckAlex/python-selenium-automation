...
class HelpPage(Page):
    ...
    HEADER = (By.XPATH, "//*[text()=' {SUBSTRING}']")
    ...
    def open_help_promotions(self):
        self.open_url('https://help.target.com/help/SubCategoryArticle?childcat=Current+promotions&parentcat=Promotions+%26+Coupons&searchQuery=')
